...
const emailUsuario = document.getElementById('emailUsuarioCadastro')
...
function cadastrarUsuario () {
    ...
    const existeUsuario = usuarios.some((dado) => dado.nome === emailUsuario.value )
    if (existeUsuario){
